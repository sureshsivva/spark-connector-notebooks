This `gateway_connection` directory is for listing the basic settings needed to connect Azure CosmosDB from on-premise environment which stays behind the firewall.
